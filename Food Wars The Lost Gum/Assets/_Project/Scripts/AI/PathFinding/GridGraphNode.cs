...
public class GridGraphNode : MonoBehaviour
{
    ...
    [SerializeField] public List<GridGraphNode> m_size2AdjacencyList = new List<GridGraphNode>();
    [SerializeField] public List<GridGraphNode> m_size3AdjacencyList = new List<GridGraphNode>();

    public bool isPartOfSolution = false;
    public bool isPartOfSmoothedPath = false;
